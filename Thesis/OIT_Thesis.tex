...
\includepdf[pages=1-15]{../Datasheets/LT3080.pdf}

\includepdf[pages=1-15]{../Datasheets/LT1129-5.pdf}

\includepdf[pages=-]{../Datasheets/MAX635.pdf}

\includepdf[pages=-]{../Datasheets/LT1006.pdf} \label{datasheet:nte941m}
